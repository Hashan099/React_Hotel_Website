...
export const HotelRoomDetail = [
  {
      ...
      featured: false,
      description:
      "Experience affordability without compromise in our Single Economy Room. Thoughtfully designed for solo travelers, this cozy yet efficient space provides all the essentials for a comfortable stay. Equipped with a comfortable single bed, a compact workspace, and a practical storage solution, our Single Economy Room offers convenience without sacrificing comfort. Ideal for budget-conscious travelers, it's the perfect choice for those seeking a practical and affordable accommodation option without compromising on quality.",
      extras: [
